...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|BETTI|❤',
    sequenceColor: '#ff69b4', // Màu pink mẫu
    gift: './gif/cat-love.gif',
    pages: [],
    enableBook: false,
    enableHeart: false,
    isSave: false,
...
const gifOptions = [
    ...
    { value: './gif/cat-love.gif', label: 'Gif2 - Cat Love' },
    ...
    try {
        ...
        if (result.success && result.data) {
            ...
            window.settings = {
                ...
                sequence: serverSettings.sequence || 'HAPPY|BIRTHDAY|TO|BETTI|❤',
...
function isLandscapeMode() {
    // ✅ MODIFIED: Always return true to allow portrait mode
    return true; // Changed from: window.innerWidth > window.innerHeight
}

function tryStartWebsiteWhenLandscape() {
    // ✅ MODIFIED: Start website immediately regardless of orientation
